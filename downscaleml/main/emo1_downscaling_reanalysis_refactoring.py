...
from downscaleml.main.emo1_config_reanalysis_dev import (ERA5_PATH, OBS_PATH, DEM_PATH, MODEL_PATH, TARGET_PATH, 
...
if __name__ == '__main__':
    ...
    if DEM:
        ...
        dem = search_files(DEM_PATH, '^emo1_at_CERRA_grid_DEM.nc$').pop()
    ...
    predictions.to_netcdf("{}/{}_lps.nc".format(str(target.parent), str(predict_file)))
