...
if __name__ == '__main__':
    ...
    Era5_ds = Era5_ds.sel(y=slice(46.17, 47.1), x=slice(10.38, 12.45)) # Just cut short this area for using the full domain
    Obs_ds = Obs_ds.sel(y=slice(46.17, 47.1), x=slice(10.38, 12.45)) # Just cut short this area for using the full domain
