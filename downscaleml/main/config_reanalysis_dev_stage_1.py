...
OBS_PATH = ROOT.joinpath('CHELSA_STAGE1')

DEM_PATH = ROOT.joinpath('DEM_STAGE1')

RESULTS = pathlib.Path('/mnt/CEPH_PROJECTS/InterTwin/Climate_Downscaling/two_stage/RESULTS_STAGE1/')
...
SEAS5_CHUNKS_forecast = {'number': 1, 'x': 161, 'y': 96, 'time': 216}
...
if PREDICTAND is 'tasmean':
    ...
    # ERA5 predictor variables on single levels
    ERA5_S_PREDICTORS=["2m_temperature", "surface_solar_radiation_downward"]
